...
| **Tests** | pytest + pytest-asyncio | 1,332 tests, no GCP required |
...
# Run tests (1,332 passing, no GCP required)
pytest tests/ -v
...
pip install -e ".[dev]"
pytest tests/ -q          # 1,332 tests, all offline
```
